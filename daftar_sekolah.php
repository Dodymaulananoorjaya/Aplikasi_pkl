...
<head>
    ...
    <title> PUPR | DATA PROYEK </title>
    <meta name="Description" content="Bootstrap Responsive Admin Web Dashboard HTML5 Template">
    <meta name="Author" content="Spruko Technologies Private Limited">
    <meta name="keywords" content="admin,admin dashboard,admin panel,admin template,bootstrap,clean,dashboard,flat,jquery,modern,responsive,premium admin templates,responsive admin,ui,ui kit.">

    <!-- Favicon -->
    <link rel="icon" href="../assets/images/svgs/logoPU.jpg" type="image/x-icon">
    ...
    <style>
        .table-responsive {
            ...
            /* Menambahkan border pada div yang mengandung tabel */
            border-radius: 5px;
            /* Opsional: memberikan sudut melengkung pada border */
            padding: 15px;
            /* Opsional: memberikan padding di dalam div */
        }
        ...
        .custom-table {
            ...
            /* Agar border cell terlihat menyatu */
        }

        .custom-table th,
        .custom-table td {
            border: 1px solid #ddd;
            /* Menambahkan border pada cell tabel */
            padding: 10px;
            text-align: center;
        }
                        ...
                        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                            <Li>
                                <div class="header-navheading border-bottom">
                                    <h6 class="main-notification-title">Miftah Firdaus </h6>
            ...
            <div class="main-sidebar" id="sidebar-scroll">
                ...
                <nav class="main-menu-container nav nav-pills flex-column sub-open">
                    ...
                    <ul class="main-menu">
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="beranda.php" class="side-menu__item">
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="tambah_data.php" class="side-menu__item">
                                <span class="shape1"></span>
                                <span class="shape2"></span>
                                <i class="ri-edit-line side-menu__icon"></i>
                                <span class="side-menu__label">Tambah Data</span>
                            </a>
                        </li>
                        <!-- End::slide -->
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="tampilkan_data.php" class="side-menu__item">
                                <span class="shape1"></span>
                                <span class="shape2"></span>
                                <i class="ti-receipt side-menu__icon"></i>
                                <span class="side-menu__label">Data Proyek</span>
                            </a>
                        </li>
                        <!-- End::slide -->
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">DATA PROYEK</h2>
                            ...
                            <div class="card-body pt-2">
                                <div class="row table-filter align-items-center">
                                    <div class="col-xl-3 col-lg-12">
                                        ...
                                        <div class="d-flex align-items-center filter-group mb-4">
                                            <!-- Tombol Tambah Data Baru dengan warna biru -->
                                            <a href="add_new.php" class="btn btn-primary">
                                                <i class="fas fa-plus"></i> Update Status Proyek
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-9 col-lg-12 d-lg-flex justify-content-end align-items-center mb-3 mt-2 mt-xl-0">
                                        <div class="d-flex mt-3 mt-lg-0">
                                            <form method="GET" action="" class="d-flex mt-3 mt-lg-0">
                                                <div class="filter-group d-inline-flex w-100">
                                                    <input type="text" name="search" class="form-control rounded-end-0" placeholder="Cari data..." value="<?= htmlspecialchars($_GET['search'] ?? ''); ?>">
                                ...
                                <div class="table-responsive border border-bottom-0">
                                    <!-- Loop through each project group (grouped by name) -->
                                    <?php foreach ($projects as $project_name => $project_data): ?>
                                        <div class="table-responsive mb-4">
                                            <!-- Header Nama Proyek -->
                                            <h5 class="custom-header"><?= htmlspecialchars($project_name); ?></h5>

                                            <!-- Tautan untuk mengunduh laporan dengan gaya tombol -->
                                            <a href="laporan.php?table=<?= urlencode($project_name); ?>" class="btn btn-primary mb-3" target="_blank">
                                            ...
                                            <table class="table custom-table mb-0">
                                                ...
                                                <tbody>
                                                    <?php foreach ($project_data as $key => $row): ?>
                                                        <tr>
                                                            <td><?= $key + 1; ?></td>
                                                            <td><?= htmlspecialchars($row['percentage']); ?>%</td>
                                                            <td><?= htmlspecialchars($row['coordinate']); ?></td>
                                                            <td><?= htmlspecialchars($row['date']); ?></td>
                                                            <td>
                                                                <?php if (!empty($row['file_src'])): ?>
                                                                    <a href="<?= htmlspecialchars($row['file_src']); ?>" target="_blank">Lihat Gambar</a>
                                                                <?php else: ?>
                                                                    <span>Gambar tidak tersedia</span>
                                                                <?php endif; ?>
                                                            </td>
                                                            <td>
                                                                <a href="edit.php?id=<?= $row['id']; ?>" class="edit-button me-2">
                                                                    <i class="fas fa-edit"></i> Edit
                                                                </a>
                                                                <a href="delete.php?id=<?= $row['id']; ?>" class="hapus-button me-2" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
        ...
        <footer class="footer mt-auto py-3 bg-white text-center">
            <div class="container">
                <span class="text-muted"> Copyright © <span id="year"></span> <a
                        href="javascript:void(0);" class="text-dark fw-semibold">PUPR</a>.
                    Designed with by <a href="javascript:void(0);">
                        <span class="fw-semibold text-primary text-decoration-underline">Firdaus & Irsyad</span>
                    </a> All
                    rights
                    reserved
                </span>
