...
<head>
    ...
    <title> BPKPAD | SPM LANGSUNG(LS) </title>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">SPM LANGSUNG(LS)</h2>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div>
                                    <div class="d-flex">
                                        <label class="main-content-label my-auto pt-2">SPM LS</label>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <?php while ($row = $result->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="print_spm_ls.php?id_spm_ls=<?= $row['id_spm_ls']; ?>" class="print-button me-2">
        ...
        <footer class="footer mt-auto py-3 bg-white text-center">
            <div class="container">
                <span class="text-muted">
                    Copyright © <span id="year"></span> <a href="javascript:void(0);" class="text-dark fw-semibold">BPKPAD</a>.
