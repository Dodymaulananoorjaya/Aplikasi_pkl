...
<head>
    ...
    <title> BPKPAD | SPM GANTI UANG(GU) </title>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">SPM GANTI UANG(GU)</h2>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div>
                                    <div class="d-flex">
                                        <label class="main-content-label my-auto pt-2">SPM GU</label>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <?php if ($result && $result->num_rows > 0): ?>
                                                ...
                                                <?php while ($row = $result->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_spm_gu.php?id_spm_gu=<?= urlencode($row['id_spm_gu']); ?>" class="edit-button me-2">
                                                                <i class="fas fa-edit"></i> Edit
                                                            </a>
                                                            <a href="print_spm_gu.php?id_spm_gu=<?= $row['id_spm_gu']; ?>" class="print-button me-2">
