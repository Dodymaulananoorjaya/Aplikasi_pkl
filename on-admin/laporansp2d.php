...
<head>
    ...
    <title>Laporan SP2D | BPKBAD</title>
...
<body>
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Halaman Laporan SP2D</li>
                        </ol>
                    </div>
                </div>
    ...
    <script>
        function openAndPrint() {
            ...
            const printWindow = window.open('spmcetak.php', '_blank');
            ...
            printWindow.onload = function() {
                ...
                printWindow.onafterprint = function() {
                    printWindow.close();
                    window.location.href = 'laporansp2d.php';
                };
            };
