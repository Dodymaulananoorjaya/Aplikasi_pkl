...
$query = "SELECT * FROM spm_gu WHERE id_spm_gu = ?";
...
if ($result->num_rows > 0) {
    ...
    echo "<script>alert('Data tidak ditemukan.'); window.location.href='dataspm_gu.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $koneksi->prepare("UPDATE spm_gu SET tanggal_spm = ?, no_rekening_bank = ?, nama_di_rekening_bank = ?, nama_bank_cabang = ?, npwp = ?, dasar_pembayaran = ? WHERE id_registrasi = ?");
    $stmt->bind_param("ssssssi", $tanggal_spm, $no_rekening_bank, $nama_di_rekening_bank, $nama_bank_cabang, $npwp, $dasar_pembayaran, $id_registrasi);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil diperbarui.'); window.location.href='dataspm_ls.php';</script>";
    } else {
...
<head>
    ...
    <title> BPKPAD | EDIT SPM GU </title>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">EDIT DATA</h2>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="row gy-4">
                                            ...
                                            <select id="id_registrasi" class="form-control" name="id_registrasi" required style="max-height: 200px; overflow-y: auto;">
                                                ...
                                                <?php foreach ($spmList as $spm): ?>
                                                    <option value="<?php echo htmlspecialchars($spm['id_registrasi']); ?>"
                                                        <?php echo ($spm['id_registrasi'] == $data['id_registrasi']) ? 'selected' : ''; ?>>
                                        ...
                                        <!-- Date Input for Tanggal Spm -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Tanggal Spm</label>
                                            <input type="date" class="form-control" id="input-name" name="tanggal_spm" value="<?php echo htmlspecialchars($data['tanggal_spm']); ?>" required>
                                        </div>

                                        <!-- Text Input for Nomor Rekening Bank -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Nomor Rekening Bank</label>
                                            <input type="text" class="form-control" id="input-name" name="no_rekening_bank" value="<?php echo htmlspecialchars($data['no_rekening_bank']); ?>" placeholder="Masukkan Nomor Rekening Bank" required>
                                        </div>

                                        <!-- Text Input for Nama Di Rekening Bank -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Nama Di Rekening Bank</label>
                                            <input type="text" class="form-control" id="input-name" name="nama_di_rekening_bank" value="<?php echo htmlspecialchars($data['nama_di_rekening_bank']); ?>" placeholder="Masukkan Nama Di Rekening Bank" required>
                                        </div>

                                        <!-- Select Input for Nama Bank Cabang -->
                                        <div class="col-12">
                                            ...
                                            <select class="form-control" id="jenis-spm" name="nama_bank_cabang" required>
                                                <option value="" disabled>Pilih Bank Cabang</option>
                                                <option value="Non Bank Kalsel" <?php echo ($data['nama_bank_cabang'] == 'Non Bank Kalsel') ? 'selected' : ''; ?>>Non Bank Kalsel</option>
                                                <option value="Bank Kalsel" <?php echo ($data['nama_bank_cabang'] == 'Bank Kalsel') ? 'selected' : ''; ?>>Bank Kalsel</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="input-name" name="npwp" value="<?php echo htmlspecialchars($data['npwp']); ?>" placeholder="Masukkan NPWP" required>
                                        </div>

                                        <!-- Text Input for Dasar Pembayaran -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Dasar Pembayaran</label>
                                            <input type="text" class="form-control" id="input-name" name="dasar_pembayaran" value="<?php echo htmlspecialchars($data['dasar_pembayaran']); ?>" placeholder="Masukkan Dasar Pembayaran" required>
                                        </div>
