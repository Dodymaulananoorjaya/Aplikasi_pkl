...
<div class="tab-buttons mt-3">
    <button id="guTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('gu')">Belum Ditransfer</button>
    <button id="lsTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('ls')">Sudah Ditransfer</button>
