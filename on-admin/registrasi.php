...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Pastikan Anda memiliki 11 parameter sesuai dengan format yang diberikan
    $stmt = $koneksi->prepare("INSERT INTO registrasi (nomor_registrasi, skpd, no_pengantar, cv, nominal, tanggal_registrasi, nomor_spm, uraian, keterangan, transfer_ke) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssssssss", $nomor_registrasi, $skpd, $no_pengantar, $cv, $nominal, $tanggal_registrasi, $nomor_spm, $uraian, $keterangan, $transfer_ke);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil disimpan.'); window.location.href='dataregistrasi.php';</script>";
    } else {
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">REGISTER</h2>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Form Registrasi</a></li>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        <!-- Nomor Registrasi -->
                                        <div class="col-12">
                                            <label for="nomor-registrasi" class="form-label">Nomor Registrasi</label>
                                            <input type="text" class="form-control" id="nomor-registrasi" name="nomor_registrasi" placeholder="Nomor Registrasi" readonly required>
                                        </div>

                                        <script>
                                            // Fungsi untuk menghasilkan nomor registrasi otomatis
                                            function generateNomorRegistrasi() {
                                                const prefix = "REG"; // Awalan nomor registrasi
                                                const currentNumber = getNextNumber(); // Nomor urut
                                                return `${prefix}-${currentNumber}`;
                                            }

                                            // Fungsi untuk mendapatkan nomor urut berikutnya
                                            function getNextNumber() {
                                                const key = "nomorRegistrasi"; // Kunci penyimpanan di localStorage
                                                let currentNumber = localStorage.getItem(key); // Ambil nomor terakhir dari localStorage

                                                if (!currentNumber) {
                                                    currentNumber = 1; // Mulai dari 1 jika belum ada data
                                                } else {
                                                    currentNumber = parseInt(currentNumber) + 1; // Tambah 1 untuk nomor berikutnya
                                                }

                                                // Simpan nomor terbaru ke localStorage
                                                localStorage.setItem(key, currentNumber);

                                                // Format nomor menjadi 4 digit (misalnya, 0001)
                                                return currentNumber.toString().padStart(4, "0");
                                            }

                                            // Mengisi input nomor registrasi secara otomatis saat halaman dimuat
                                            document.addEventListener("DOMContentLoaded", () => {
                                                const nomorRegistrasiInput = document.getElementById("nomor-registrasi");
                                                if (nomorRegistrasiInput) {
                                                    nomorRegistrasiInput.value = generateNomorRegistrasi();
                                                }
                                            });
                                        </script>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <select class="form-select" id="skpd" name="skpd" required>
                                                ...
                                                <option value="Badan Kepegawaian Daerah, Pendidikan dan Pelatihan">Badan Kepegawaian Daerah, Pendidikan dan Pelatihan</option>
                                                <option value="Badan Kesatuan Bangsa dan Politik">Badan Kesatuan Bangsa dan Politik</option>
                                                <option value="Badan Pengelola Keuangan Pendapatan dan Aset Daerah">Badan Pengelola Keuangan Pendapatan dan Aset Daerah</option>
                                                <option value="Badan Penanggulangan Bencana Daerah">Badan Penanggulangan Bencana Daerah</option>
                                                <option value="Badan Perencanaan Pembangunan Daerah - Penelitian dan Pengembangan">Badan Perencanaan Pembangunan Daerah - Penelitian dan Pengembangan</option>
                                                <option value="Dinas Kebudayaan, Kepemudaan, Olahraga dan Pariwisata">Dinas Kebudayaan, Kepemudaan, Olahraga dan Pariwisata</option>
                                                ...
                                                <option value="Dinas Koperasi, Usaha Mikro dan Tenaga Kerja">Dinas Koperasi, Usaha Mikro dan Tenaga Kerja</option>
                                                ...
                                                <option value="Dinas Pengendalian Penduduk, KB dan Pemberdayaan Masyarakat">Dinas Pengendalian Penduduk, KB dan Pemberdayaan Masyarakat</option>
                                                <option value="Dinas Perdagangan dan Perindustrian">Dinas Perdagangan dan Perindustrian</option>
                                                <option value="Dinas Perhubungan">Dinas Perhubungan</option>
                                                <option value="Dinas Perpustakaan dan Arsip">Dinas Perpustakaan dan Arsip</option>
                                                ...
                                                <option value="Bagian Humas dan Protokol">Bagian Humas dan Protokol</option>
                                                <option value="Bagian Kesra dan Kemasyarakatan">Bagian Kesra dan Kemasyarakatan</option>
                                                <option value="Bagian Layanan Pengadaan">Bagian Layanan Pengadaan</option>
                                        ...
                                        <!-- No Pengantar -->
                                        <div class="col-12">
                                            <label for="no-pengantar" class="form-label">No Pengantar</label>
                                            <input type="text" class="form-control" id="no-pengantar" name="no_pengantar" placeholder="No Pengantar" required>
                                        </div>

                                        <!-- CV -->
                                        <div class="col-12">
                                            <label for="cv" class="form-label">CV</label>
                                            <input type="text" class="form-control" id="cv" name="cv" placeholder="CV" required>
                                        </div>
                                        ...
                                        <!-- Tanggal Registrasi -->
                                        <div class="col-12">
                                            <label for="tanggal-registrasi" class="form-label">Tanggal Registrasi</label>
                                            <input type="date" class="form-control" id="tanggal-registrasi" name="tanggal_registrasi" required>
                                        </div>

                                        <!-- Nomor SPM -->
                                        <div class="col-12">
                                            <label for="nomor-spm" class="form-label">Nomor SPM</label>
                                            <input type="text" class="form-control" id="nomor-spm" name="nomor_spm" placeholder="Masukkan Nomor SPM" required>
                                        </div>
                                        ...
                                        <!-- Transfer Ke -->
                                        <div class="col-12">
                                            <label for="transfer-ke" class="form-label">Transfer Ke</label>
                                            <select class="form-select" id="transfer-ke" name="transfer_ke" required>
                                                <option value="" disabled selected>Pilih Transfer Ke</option>
                                                <option value="Bank Kalsel">Bank Kalsel</option>
                                                <option value="NonBank kalsel">NonBank Kalsel</option>
                                            </select>
                                        </div>
