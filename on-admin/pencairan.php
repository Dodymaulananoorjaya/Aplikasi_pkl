...
<div class="tab-buttons mt-3">
    ...
    <button id="tuTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('tu')">Sedang Diproses</button>
    <button id="lsTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('ls')">Sudah Ditransfer</button>
    <button id="lsTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('ls')">Transfer Gagal</button>
