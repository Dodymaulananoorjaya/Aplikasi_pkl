...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $koneksi->prepare("INSERT INTO spm_tu (id_registrasi, jenis_spm, tanggal_spm, no_rekening_bank, nama_di_rekening_bank, nama_bank_cabang, npwp, dasar_pembayaran) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil disimpan.'); window.location.href='dataspm_tu.php';</script>";
    } else {
...
<head>
    ...
    <title> BPKBAD | SPM TU(TAMBAH UANG) </title>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">UPLOAD SPM TU(TAMBAH UANG)</h2>
