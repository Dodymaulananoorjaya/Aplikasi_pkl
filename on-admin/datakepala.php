                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="beranda.php" class="header-logo">
                                ...
                                <img src="../assets/images/brand-logos/BPKPAD_Kota_Banjarmasin.png" alt="logo" class="desktop-dark" style="height: 50px; width: 50px;">
        ...
        <aside class="app-sidebar sticky" id="sidebar">
            ...
            <div class="main-sidebar-header">
                <a href="beranda.php" class="header-logo">
                    ...
                    <img src="../assets/images/brand-logos/BPKPAD_Kota_Banjarmasin.png" class="desktop-dark" alt="logo" style="height: 50px; width: 50px;">
                </a>
            </div>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">Kepala</h2>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card custom-card">
                            <div class="card-header border-bottom-0 pb-0">
                                <div>
                                    <div class="d-flex">
                                        <label class="main-content-label my-auto pt-2">Kepala</label>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <?php if ($result && $result->num_rows > 0): ?>
                                                ...
                                                <?php while ($row = $result->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit_kepala.php?id_kepala=<?= $row['id_kepala']; ?>" class="edit-button me-2">
                                                                <i class="fas fa-edit"></i> Edit
                                                            </a>
                                                            <a href="print_kepala.php?id_kepala=<?= $row['id_kepala']; ?>" class="print-button me-2">
