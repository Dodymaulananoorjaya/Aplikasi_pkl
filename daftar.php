...
<head>
    ...
    <title>Daftar | BPKPAD Kota Banjarmasin</title>
                    ...
                    <div class="card-body">
                        ...
                        <form action="cek_daftar.php" method="post">
                            ...
                            <div class="form-group text-start">
                                ...
                                <input class="form-control" placeholder="Masukkan Nama" type="text" name="nama">
                            </div>
                            <div class="form-group text-start">
                                <label class="form-label">Email</label>
                                <input class="form-control" placeholder="Masukkan Email" type="text" name="email">
                            </div>
                            <div class="form-group text-start">
