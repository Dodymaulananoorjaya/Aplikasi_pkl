...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $kode_rekening_beban = $_POST['kode_rekening_beban'];
    $uraian_beban = $_POST['uraian_beban'];
    $nilai_beban = $_POST['nilai_beban'];
    $uraian_potongan = $_POST['uraian_potongan'];
    $jumlah_potongan = $_POST['jumlah_potongan'];

    $stmt = $koneksi->prepare("INSERT INTO isi_spm (id_registrasi, kode_rekening_beban, uraian_beban, nilai_beban, uraian_potongan, jumlah_potongan) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("isssss", $id_registrasi, $kode_rekening_beban, $uraian_beban, $nilai_beban, $uraian_potongan, $jumlah_potongan);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil disimpan.'); window.location.href='dataisi_spm.php';</script>";
    } else {
        echo "<script>alert('Terjadi kesalahan: " . $stmt->error . "'); window.location.href='isi_spm.php';</script>";
    }
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">UPLOAD ISI SPM</h2>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="row gy-4">
                                        ...
                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Kode Rekening Beban</label>
                                            <input type="text" class="form-control" id="input-name" name="kode_rekening_beban" placeholder="Masukkan Dasar Pembayaran" required>
                                        </div>

                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Uraian Beban</label>
                                            <input type="text" class="form-control" id="input-name" name="uraian_beban" placeholder="Masukkan Dasar Pembayaran" required>
                                        </div>

                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Nilai Beban</label>
                                            <input type="text" class="form-control" id="input-name" name="nilai_beban" placeholder="Masukkan Dasar Pembayaran" required>
                                        </div>

                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Uraian Potongan</label>
                                            <input type="text" class="form-control" id="input-name" name="uraian_potongan" placeholder="Masukkan Dasar Pembayaran" required>
                                        </div>

                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Jumlah Potongan</label>
                                            <input type="text" class="form-control" id="input-name" name="jumlah_potongan" placeholder="Masukkan Dasar Pembayaran" required>
                                        </div>
