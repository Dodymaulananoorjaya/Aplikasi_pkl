...
$query = "SELECT * FROM perbaikan WHERE id_perbaikan = ?";
...
if ($result->num_rows > 0) {
    ...
    echo "<script>alert('Data tidak ditemukan.'); window.location.href='perbaikan.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_query = "UPDATE perbaikan SET id_spm = ?, alasan = ? WHERE id_perbaikan = ?";
    $stmt = $koneksi->prepare($update_query);
    $stmt->bind_param("isi", $id_spm, $alasan, $id_perbaikan);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil diperbarui.'); window.location.href='perbaikan.php';</script>";
    } else {
...
<head>
    ...
    <title> BPKBAD | TAMBAH DATA </title>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">UPLOAD PERBAIKAN</h2>
