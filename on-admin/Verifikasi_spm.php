...
// Tentukan konten berdasarkan parameter 'type'
switch($type) {
    case 'gu':
        // Konten untuk Ganti Uang (GU)
        echo "<h2>Ganti Uang (GU)</h2><p>Konten untuk Ganti Uang.</p>";
        break;
    case 'tu':
        // Konten untuk Tambah Uang (TU)
        echo "<h2>Tambah Uang (TU)</h2><p>Konten untuk Tambah Uang.</p>";
        break;
    case 'ls':
        // Konten untuk Langsung (LS)
        echo "<h2>Langsung (LS)</h2><p>Konten untuk Langsung.</p>";
        break;
    default:
        echo "<p>Silakan pilih opsi untuk melihat konten.</p>";
        break;
}
?>
...
<body>
    ...
    <div class="page">
        ...
        <div class="main-content app-content">
            ...
            <h2>  </h2>
    <div>
        <button class="tab active" onclick="loadContent('dataregistrasi_spm.php')">REG</button>
        <button class="tab" onclick="loadContent('verifikasi_spm_tu.php')">TU</button>
        <button class="tab" onclick="loadContent('verifikasi_spm_ls.php')">LS</button>
        <button class="tab" onclick="loadContent('verifikasi_spm_gu.php')">GU</button>
        <button class="tab" onclick="loadContent('verifikasi_spm_hapus.php')">SPM HAPUS</button>
        <button class="tab" onclick="loadContent('verifikasi_spm_tolak.php')">SPM TOLAK</button>
        <button class="tab" onclick="loadContent('verifikasi_spm_setuju.php')">SPM VERIFIKASI</button>
        <button class="tab" onclick="loadContent('verifikasi_data.php')">VERIFIKASI</button>
    </div>
