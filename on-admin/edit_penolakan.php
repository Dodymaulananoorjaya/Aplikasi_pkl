...
$id_penolakan = $_GET['id_penolakan'];
$query = "SELECT * FROM penolakan WHERE id_penolakan = ?";
$stmt = $koneksi->prepare($query);
$stmt->bind_param("i", $id_penolakan);
$stmt->execute();
...
if ($result->num_rows > 0) {
    ...
    echo "<script>alert('Data tidak ditemukan.'); window.location.href='penolakan.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_query = "UPDATE penolakan SET id_spm = ?, alasan = ? WHERE id_penolakan = ?";
    $stmt = $koneksi->prepare($update_query);
    $stmt->bind_param("isi", $id_spm, $alasan, $id_penolakan);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil diperbarui.'); window.location.href='penolakan.php';</script>";
    } else {
...
<head>
    ...
    <title> BPKBAD | TAMBAH DATA PENOLAKAN </title>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">UPLOAD DATA PENOLAKAN</h2>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="row gy-4">
                                        ...
                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Alasan</label>
                                            <input type="text" class="form-control" id="input-name" name="alasan" placeholder="Alasan" required>
                                        </div>
