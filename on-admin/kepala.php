...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $koneksi->prepare("INSERT INTO kepala (nama_kepala, jabatan, nip) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $nama_kepala, $jabatan, $nip);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil disimpan.'); window.location.href='datakepala.php';</script>";
    } else {
        echo "<script>alert('Terjadi kesalahan: " . $stmt->error . "'); window.location.href='kepala.php';</script>";
    }
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">UPLOAD DATA KEPALA</h2>
                            ...
                            <div class="card-body">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="row gy-4">
                                        ...
                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">Nama Kepala</label>
                                            <input type="text" class="form-control" id="input-name" name="nama_kepala" placeholder="Masukkan Nama Kepala" required>
                                        </div>

                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">NIP</label>
                                            <input type="text" class="form-control" id="input-name" name="nip" placeholder="Masukkan NIP" required>
                                        </div>
