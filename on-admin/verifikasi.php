...
<head>
    ...
    <title> BPKPAD | SURAT PERINTAH PENCAIRAN DANA </title>
                    ...
                    <div class="header-element">
                        ...
                        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-none">
                                    <p class="fw-semibold mb-0">Dody MNJ</p>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">SURAT PERINTAH PENCAIRAN DANA</h2>
...
<div class="tab-buttons mt-3">
    <button id="regTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('reg')">Register</button>
    <button id="guTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('gu')">Ganti Uang (GU)</button>
    <button id="tuTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('tu')">Tambah Uang (TU)</button>
    <button id="lsTab" class="btn btn-outline-secondary" onclick="updateVerificationButtons('ls')">Langsung (LS)</button>
    <button id="dihapusTab" class="btn btn-outline-danger" onclick="updateVerificationButtons('dihapus')">Dihapus</button>
    <button id="ditolakTab" class="btn btn-outline-dark" onclick="updateVerificationButtons('ditolak')">Ditolak</button>
    <button id="spmverifikasiTab"Vclass="btn btn-outline-dark" onclick="updateVerificationButtons('spmverifikasi')">SPM Verifikasi</button>
    <button id="verifikasiTab"Vclass="btn btn-outline-dark" onclick="updateVerificationButtons('verifikasi')">Verifikasi</button>
</div>

    <!-- Table with Data -->
    <div class="mt-4 table-responsive border border-bottom-0">
                ...
                <?php if ($result && $result->num_rows > 0): ?>
                    ...
                    <?php while ($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_sp2d.php?id_sp2d=<?= urlencode($row['id_sp2d']); ?>" class="edit-button me-2">
                                    <i class="fas fa-edit"></i> Edit
                                </a>
                                <a href="print_sp2d.php?id_sp2d=<?= urlencode($row['id_sp2d']); ?>" class="edit-button me-2">
