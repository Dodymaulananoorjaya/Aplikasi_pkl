...
<head>
    ...
    <title>Laporan PENOMORAN | BPKBAD</title>
...
<body>
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Halaman Laporan PENOMORAN</li>
                        </ol>
                    </div>
                </div>
    ...
    <script>
        function openAndPrint() {
            ...
            const printWindow = window.open('penomorancetak.php', '_blank');
            ...
            printWindow.onload = function() {
                ...
                printWindow.onafterprint = function() {
                    printWindow.close();
                    window.location.href = 'laporanpenomoran.php';
                };
            };
