...
$id_sp2d = $_GET['id_sp2d'];
$query = "SELECT * FROM sp2d WHERE id_sp2d = ?";
...
if ($result->num_rows > 0) {
    ...
    echo "<script>alert('Data tidak ditemukan.'); window.location.href='sp2d.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_query = "UPDATE sp2d SET id_spm = ?, keterangan = ? WHERE id_sp2d = ?";
    $stmt = $koneksi->prepare($update_query);
    $stmt->bind_param("isi", $id_spm, $keterangan, $id_sp2d);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil diperbarui.'); window.location.href='sp2d.php';</script>";
    } else {
...
$query = "SELECT id_spm, skpd FROM spm";
...
<head>
    ...
    <title> DINAS PENDIDIKAN | TAMBAH DISTRIBUSI BAHAN AJAR </title>
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">UPLOAD DISTRIBUSI BAHAN AJAR</h2>
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-md-6 col-xl-6 col-xxl-6 mb-2">
                                            <label for="id_spm" class="form-label">Skpd</label>
                                            <select id="id_spm" class="form-control" name="id_spm" required style="max-height: 200px; overflow-y: auto;">
                                                <option value="">Pilih Skpd</option>
                                                <?php foreach ($spmList as $spm): ?>
                                                    <option value="<?php echo htmlspecialchars($spm['id_spm']); ?>">
                                        ...
                                        <!-- Percentage Input -->
                                        <div class="col-12">
                                            <label for="input-percentage" class="form-label">dari</label>
                                            <input type="text" class="form-control" id="input-name" name="dari" placeholder="Masukkan dari" required>
                                        </div>

                                        <!-- Coordinate Input -->
                                        <div class="col-12">
                                            <label for="input-coordinate" class="form-label">tahun anggaran</label>
                                            <input type="text" class="form-control" id="input-name" name="tahun_anggaran" placeholder="tahun anggaran" required>
                                        </div>

                                        <!-- Date Input -->
                                        <div class="col-12">
                                            <label for="input-date" class="form-label">keterangan</label>
                                            <input type="text" class="form-control" id="input-name" name="keterangan" placeholder="Masukkan keterangan" required>
                                        </div>
