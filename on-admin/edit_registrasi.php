...
$query = "SELECT * FROM registrasi WHERE id_registrasi = ?";
...
if ($result->num_rows > 0) {
    ...
    echo "<script>alert('Data tidak ditemukan.'); window.location.href='dataregistrasi.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_query = "UPDATE registrasi SET nomor_registrasi = ?, skpd = ?, no_pengantar = ?, cv = ?, nominal = ?, tanggal_registrasi = ?, nomor_spm = ?, uraian = ?, keterangan = ?, transfer_ke = ? WHERE id_registrasi = ?";
    $stmt = $koneksi->prepare($update_query);
    $stmt->bind_param("ssssssssssi", $nomor_registrasi, $skpd, $no_pengantar, $cv, $nominal, $tanggal_registrasi, $nomor_spm, $uraian, $keterangan, $transfer_ke, $id_registrasi);

    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil diperbarui.'); window.location.href='dataregistrasi.php';</script>";
    } else {
        ...
        <div class="main-content app-content">
            <div class="container-fluid">
                ...
                <div class="d-md-flex d-block align-items-center justify-content-between page-header-breadcrumb">
                    <div>
                        <h2 class="main-content-title fs-24 mb-1">UPLOAD REGISTER</h2>
                                    ...
                                    <div class="row gy-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="nomor_registrasi" name="nomor_registrasi"
                                                value="<?php echo htmlspecialchars($data['nomor_registrasi']); ?>" required>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="skpd" name="skpd"
                                                value="<?php echo htmlspecialchars($data['skpd']); ?>" required>
                                        </div>

                                        <!-- No Pengantar -->
                                        <div class="col-12">
                                            <label for="no_pengantar" class="form-label">No Pengantar</label>
                                            <input type="text" class="form-control" id="no_pengantar" name="no_pengantar"
                                                value="<?php echo htmlspecialchars($data['no_pengantar']); ?>" required>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="cv" name="cv"
                                                value="<?php echo htmlspecialchars($data['cv']); ?>" required>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="nominal" name="nominal"
                                                value="<?php echo htmlspecialchars($data['nominal']); ?>" required>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="date" class="form-control" id="tanggal_registrasi" name="tanggal_registrasi"
                                                value="<?php echo htmlspecialchars($data['tanggal_registrasi']); ?>" required>
                                        </div>

                                        <!-- Nomor SPM -->
                                        <div class="col-12">
                                            <label for="nomor_spm" class="form-label">Nomor SPM</label>
                                            <input type="text" class="form-control" id="nomor_spm" name="nomor_spm"
                                                value="<?php echo htmlspecialchars($data['nomor_spm']); ?>" required>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control" id="uraian" name="uraian"
                                                value="<?php echo htmlspecialchars($data['uraian']); ?>" required>
                                        </div>
                                        ...
                                        <!-- Transfer Ke -->
                                        <div class="col-12">
                                            <label for="transfer_ke" class="form-label">Transfer Ke</label>
                                            <input type="text" class="form-control" id="transfer_ke" name="transfer_ke"
                                                value="<?php echo htmlspecialchars($data['transfer_ke']); ?>" required>
                                        </div>
